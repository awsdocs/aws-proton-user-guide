# How AWS Proton works with IAM<a name="security_iam_service-with-iam"></a>
...
## Identity\-based policies for AWS Proton<a name="security_iam_service-with-iam-id-based-policies"></a>
...
### Identity\-based policy examples for AWS Proton<a name="security_iam_service-with-iam-id-based-policies-examples"></a>
...
## Resource\-based policies within AWS Proton<a name="security_iam_service-with-iam-resource-based-policies"></a>
...
## Policy actions for AWS Proton<a name="security_iam_service-with-iam-id-based-policies-actions"></a>
...
## Policy resources for AWS Proton<a name="security_iam_service-with-iam-id-based-policies-resources"></a>
...
## Policy condition keys for AWS Proton<a name="security_iam_service-with-iam-id-based-policies-conditionkeys"></a>
...
## Access control lists \(ACLs\) in AWS Proton<a name="security_iam_service-with-iam-acls"></a>
...
## Attribute\-based access control \(ABAC\) with AWS Proton<a name="security_iam_service-with-iam-tags"></a>
...
## Using Temporary credentials with AWS Proton<a name="security_iam_service-with-iam-roles-tempcreds"></a>
...
## Cross\-service principal permissions for AWS Proton<a name="security_iam_service-with-iam-principal-permissions"></a>
...
## Service roles for AWS Proton<a name="security_iam_service-with-iam-roles-service"></a>
...
## Service\-linked roles for AWS Proton<a name="security_iam_service-with-iam-roles-service-linked"></a>
